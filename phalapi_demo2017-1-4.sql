...
INSERT INTO `ic_article` (`id`, `title`, `file_name`, `file_url`, `original_url`, `type_id`, `ctime`, `status`, `is_show`) VALUES
(1, '1', '1', 1, '1', 1, 1, 1, 1);
...
CREATE TABLE IF NOT EXISTS `ic_article_cat_links` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='微信分类目录链接，' AUTO_INCREMENT=1 ;
